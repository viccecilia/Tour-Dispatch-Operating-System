...
const statusMap: Record<string, string> = {
  ...
  payment_requested: "bg-amber-50 text-amber-700 ring-amber-200",
  receipt_uploaded: "bg-blue-50 text-blue-700 ring-blue-200",
  ...
  listed: "bg-amber-50 text-amber-700 ring-amber-200",
  ...
  auction_listed: "bg-amber-50 text-amber-700 ring-amber-200",
  auction_claimed: "bg-blue-50 text-blue-700 ring-blue-200",
  auction_expired: "bg-slate-100 text-slate-700 ring-slate-300",
  auction_cancelled: "bg-slate-100 text-slate-700 ring-slate-300",
};
...
const statusLabelMap: Record<string, string> = {
  ...
  auction_listed: "发布中",
  auction_claimed: "已接单",
  auction_expired: "超时撤回",
  auction_cancelled: "已撤回",
  admin: "管理员",
  dispatcher: "调度员",
  driver: "司机",
};
