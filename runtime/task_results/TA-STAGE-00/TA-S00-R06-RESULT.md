...
Implemented through the independent travel-agency module: foundation tenant, role, account, password, WeChat-binding, order model, and platform boundary support.
