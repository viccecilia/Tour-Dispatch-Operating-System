...
Implemented through the independent travel-agency module: customer-service order intake, parse preview, source/customer selection, confirmation, filtering, and batch-ready status fields.
